<h1>Manually Creating A Paginator with Laravel 5.8 using a collection with merge method<br> Creación manual del metodo paginate con Laravel 5.8 utilizando una colección con merge</h1>
